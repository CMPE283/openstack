...
print '<div>'
print '<br></br>'
print '<div align="left"> Usage for the last 5 days &nbsp &nbsp &nbsp\
        <a><button type="button" id="last-five-usage" onclick="showLastFive()"> Show/Hide </button></a>'
print ' <div style="float:right;"> Click here to generate bill: &nbsp &nbsp &nbsp\
        <a><button type="button" id="generate-bill" onclick="generateBill()"> Generate </button></a> </div></div>'
print '</div>'
print '</body>'
print '</html>'
